...
import com.example.cai.kh5.dummy.DummyContent.DummyItem;
...
public class MyDetailRecyclerViewAdapter extends RecyclerView.Adapter<MyDetailRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdImage.setBackgroundResource(mValues.get(position).imgid);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mIdImage=(ImageView) view.findViewById(R.id.img_detail);
